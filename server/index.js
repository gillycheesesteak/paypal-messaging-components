...
export default (options, markup) => {
    ...
    // const template = Template.getTemplateNode(container, options, markup);
    // const newNode =
    ...
    //     .map(img => new Promise(res => img.addEventListener('load', res)))
    ...
    // return Promise.all(layoutProms).then(
    //     () =>
    //         new Promise(resolve =>
